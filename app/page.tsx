  ...
  return (
    <main>
      ...
      <div className="w-full sm:w-1/2 h-full bg-white flex flex-col justify-evenly  relative items-center place-content-center">
        ...
        <input
          className="rounded-md border-black px-4 py-2 bg-inherit border "
          name="email"
        ...
        <input
          className="rounded-md border-black px-4 py-2 bg-inherit border mb-6"
          type="password"
          name="password"
          placeholder="••••••••"
          required
        ...
        <SubmitButton
          formAction={signIn}
          className="rounded-lg bg-black text-white px-4 py-2 mb-2"
        ...
        <SubmitButton
          formAction={signUp}
          className="border bg-black text-white border-foreground/20 rounded-lg px-4 py-2 mb-2"
